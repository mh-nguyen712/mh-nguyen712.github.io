...
\fcolorbox{white}{darkcol}{\begin{minipage}[c][4.5cm][c]{1\mpwidth}
	\begin {center}
		...
		\normalsize{ \textcolor{white} {I am a second-year PhD candidate in MAMBO team at Toulouse university (expected graduation: Dec. 2026), advised by \href{https://www.math.univ-toulouse.fr/~weiss/}{Prof. Pierre Weiss} and \href{https://edouardpauwels.fr/}{Prof. Edouard Pauwels}. My research explores generative models for inverse problems in imaging, with applications in microscopy. }}
	\end {center}
\end{minipage}}
