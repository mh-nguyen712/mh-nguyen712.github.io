...
\fcolorbox{white}{darkcol}{\begin{minipage}[c][4.5cm][c]{1\mpwidth}
	\begin {center}
		...
		\normalsize{ \textcolor{white} {I am a PhD student in MAMBO team at Université de Toulouse (expected graduation: December 2026), advised by \href{https://www.math.univ-toulouse.fr/~weiss/}{Prof. Pierre Weiss} and \href{https://edouardpauwels.fr/}{Prof. Edouard Pauwels}. My research focuses on generative models for inverse problems in imaging, with applications to microscopy. }}
	\end {center}
\end{minipage}}
