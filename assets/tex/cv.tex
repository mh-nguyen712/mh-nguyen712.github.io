...
\usepackage[backend=biber,
           ...
           maxbibnames=4,giveninits=true,uniquename=false]{biblatex}
...
\fcolorbox{white}{darkcol}{\begin{minipage}[c][4.5cm][c]{1\mpwidth}
	\begin {center}
		...
		\vskip -0.1in
		\normalsize{ \textcolor{white} {I am a 3rd-year PhD candidate in MAMBO team at Toulouse university (expected graduation: Dec. 2026), advised by \href{https://www.math.univ-toulouse.fr/~weiss/}{Prof. Pierre Weiss} and \href{https://edouardpauwels.fr/}{Prof. Edouard Pauwels}.
...
\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}} cccc}
	& \textbf{Python (advanced):} PyTorch (DDP, AMP), Jax, scientific computing & \textbf{C/C++ (intermediate)}  & 
\end{tabular*}
% \vfill\null
...
\end{itemize}
\cvsection{Honor and Awards}

\cvevent
	{Nov. 2024}
	{French National Prize for Open Science Library for DeepInverse.}
	{\href{https://www.ouvrirlascience.fr/deepinverse/}{Documentation prize}}
	{\textit{By Ministère de l'Enseignement Supérieur et de la Recherche} }
	{}
	{}
\vfill\null
...
\cvevent
	...
	{}
	{\textit{Fully Funded Doctoral Research Grant (2023-2026)} }
	{}
	{}
\vfill\null
...
\cvevent
	{2023}
	{IA Pau Competition}
	{\href{https://www.ouvrirlascience.fr/deepinverse/}{Best project award}}
	{\textit{By IA Pau organization, funded by Boavizta (1500eur prize).} }
	{}
	{}
\vfill\null
